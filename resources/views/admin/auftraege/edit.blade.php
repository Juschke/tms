...
<div class="container-fluid h-100">
    ...
    <div class="sap-topnav sticky-top bg-white border-bottom mb-3 py-2" style="z-index:1000;">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <h1 class="sap-title mb-0">Auftrag bearbeiten</h1>
    ...
    <!-- Formular -->
    <form id="auftragForm"
          action="{{ route('admin.auftraege.update', $auftrag->id) }}"
          method="POST"
    ...
    >
        @csrf
        @method('PUT') <!-- Wichtig für das Update -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div id="auftragsdaten" class="sap-card h-100">
                                    ...
                                    <div class="sap-form-group">
                                        <div class="input-group">
                                            ...
                                            <div class="sap-tooltip" style="margin-bottom:2px;">
                                                ...
                                                <span class="tooltip-text">Eindeutige Nummer zur Identifizierung</span>
                                            </div>
                                            <input type="text"
                                                   class="sap-form-control @error('auftragsnummer') is-invalid @enderror"
                                                   id="auftragsnummer"
                                                   name="auftragsnummer"
                                                   value="{{ old('auftragsnummer', $auftrag->auftragsnummer) }}"
                                            >
                                        </div>
                            ...
                            <!-- 2. Zeile: Erstellungsdatum & Fälligkeitsdatum -->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="sap-form-group">
                                        ...
                                        <input type="date"
                                               ...
                                               value="{{ old('erstellungsdatum', $auftrag->erstellungsdatum?->format('Y-m-d')) }}"
                                        >
                                    ...
                                    <div class="sap-form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="date"
                                                   ...
                                                   id="faellig_am"
                                                   name="faellig_am"
                                                   value="{{ old('faellig_am', $auftrag->faellig_am?->format('Y-m-d')) }}"
                                            >
                                        </div>
                                        @error('faellig_am')
                                          <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="sap-form-group">
                                        ...
                                        >
                                            ...
                                            @foreach(['Neu','InBearbeitung','Abgeschlossen','Storniert'] as $stat)
                                                <option value="{{ $stat }}"
                                                    {{ old('status', $auftrag->status) == $stat ? 'selected' : '' }}>
                                                    {{ $stat }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="sap-form-group">
                                        ...
                                        >
                                            <option value="">- Bitte wählen -</option>
                                            @foreach(['Niedrig','Normal','Hoch','Dringend'] as $prio)
                                                <option value="{{ $prio }}"
                                                    {{ old('prioritaet', $auftrag->prioritaet) == $prio ? 'selected' : '' }}>
                                                    {{ $prio }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="sap-form-group">
                                ...
                                <textarea class="sap-form-control @error('anmerkungen') is-invalid @enderror"
                                          ...
                                          name="anmerkungen"
                                          rows="2"
                                >{{ old('anmerkungen', $auftrag->anmerkungen) }}</textarea>
                                @error('anmerkungen')
                                  <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div id="sprachen" class="sap-card">
                                    ...
                                    <div class="mt-2" id="selectedSprachenContainer">
                                        @if(old('sprachen'))
                                            ...
                                            @endforeach
                                        @else
                                            <!-- Falls du in der Datenbank eine Mehrfachspeicherung hast,
                                                 hier die bereits zugewiesenen Sprachen (falls existieren).
                                                 Ansonsten nur quell_sprache, ziel_sprache. 
                                            -->
                                        @endif
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <div class="sap-form-group">
                                                ...
                                                >
                                                    <option value="">- Bitte wählen -</option>
                                                    @foreach($sprachen as $spr)
                                                        <option value="{{ $spr->id }}"
                                                           {{ old('quell_sprache', $auftrag->quell_sprache) == $spr->id ? 'selected' : '' }}>
                                                           {{ $spr->bez_lang }} ({{ $spr->bez_kurz }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                                @error('quell_sprache')
                                        ...
                                        <div class="col-md-6">
                                            <div class="sap-form-group">
                                                ...
                                                >
                                                    ...
                                                    @foreach($sprachen as $spr)
                                                        <option value="{{ $spr->id }}"
                                                           {{ old('ziel_sprache', $auftrag->ziel_sprache) == $spr->id ? 'selected' : '' }}>
                                                           {{ $spr->bez_lang }} ({{ $spr->bez_kurz }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div id="kunde" class="sap-card">
                                    ...
                                    <div class="sap-form-group">
                                        ...
                                        <div class="sap-search-container d-flex">
                                            <input type="text" class="sap-form-control"
                                                   id="kunde_search"
                                            ...
                                            <input type="hidden"
                                                   id="kunde_id"
                                                   name="kunde_id"
                                                   value="{{ old('kunde_id', $auftrag->kunde_id) }}">
                                        </div>
                                        <div id="selected_kunde" class="mt-2">
                                            @php
                                                $existingKunde = $kunden->firstWhere('id', old('kunde_id', $auftrag->kunde_id));
                                            @endphp
                                            @if($existingKunde)
                                                <div class="p-2 border rounded">
                                                    {{ $existingKunde->firmenname }}
                                                </div>
                                            @endif
                                        </div>
                                        @error('kunde_id')
                                    ...
                                    <div class="sap-form-group">
                                        ...
                                        <div class="sap-search-container d-flex">
                                            ...
                                            <input type="hidden"
                                                   id="benutzer_id"
                                                   name="benutzer_id"
                                                   value="{{ old('benutzer_id', $auftrag->zugewiesen_user_id) }}">
                                        </div>
                                        <div id="selected_benutzer" class="mt-2">
                                            @php
                                                $existingUser = $benutzer->firstWhere('id', old('benutzer_id', $auftrag->zugewiesen_user_id));
                                            @endphp
                                            @if($existingUser)
                                                <div class="p-2 border rounded">
                                                    {{ $existingUser->name }}
                                    ...
                                    <div class="sap-form-group">
                                        ...
                                        <div class="sap-search-container d-flex">
                                            ...
                                            <input type="hidden"
                                                   id="partner_id"
                                                   name="partner_id"
                                                   value="{{ old('partner_id', $auftrag->partner_id) }}">
                                        </div>
                                        <div id="selected_partner" class="mt-2">
                                            @php
                                                $existingPartner = $partner->firstWhere('id', old('partner_id', $auftrag->partner_id));
                                            @endphp
                                            @if($existingPartner)
                                                <div class="p-2 border rounded">
                                    ...
                                    <div class="sap-form-group">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input"
                                                   ...
                                                   name="angerufen"
                                                   value="1"
                                                   @if(old('angerufen', $auftrag->angerufen)) checked @endif
                                            >
                        ...
                        <div id="preiskalkulation" class="sap-card h-100">
                            ...
                            <div class="table-responsive">
                                <table id="kostenTable" class="table">
                                    ...
                                    <tbody>
                                        <!-- Bestehende Positionen? $auftrag->positionen ... 
                                             oder dynamisch mit addPosition() 
                                        -->
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="sap-form-group">
                                        ...
                                        <input type="number"
                                               ...
                                               id="rabatt_prozent"
                                               name="rabatt_prozent"
                                               value="{{ old('rabatt_prozent', $auftrag->rabatt_prozent) }}"
                                        >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="sap-form-group">
                                        ...
                                        <input type="number"
                                               ...
                                               id="anzahlung"
                                               name="anzahlung"
                                               value="{{ old('anzahlung', $auftrag->anzahlung) }}"
                                        >
                                    </div>
                                </div>
                            </div>
        ...
        <input type="hidden" name="preis_gesamt" id="preis_gesamt_input"
               value="{{ old('preis_gesamt', $auftrag->preis_gesamt) }}">
    </form>
</div>
